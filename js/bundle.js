...
*/
    function triggerCommand(i) {
        ...
        else if ("logo" === i.toLowerCase() ) e.innerHTML += logoCmd;
...
,
    ...
    logoCmd = '<div class="inlineContainer">    <img src="img/title.png" alt class="avatar" />  </div>  <br />';
